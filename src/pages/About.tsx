            ...
            <motion.div {...fadeUp} className="grid md:grid-cols-3 gap-8 items-start">
              ...
              <div className="md:col-span-2 space-y-5">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>{t(
                      'Ich bin Sohrab („Dr. So"). Und ja: Ich wirke oft klar und strukturiert – aber das kommt auch daher, dass ich Unsicherheit gut kenne. Viele meiner wichtigsten Lernschritte kamen nicht aus Erfolgen, sondern aus Umwegen, Fehlannahmen und Momenten, in denen ich mich neu sortieren musste.',
                      "I'm Sohrab ('Dr. So'). Yes, I often come across as clear and structured — but that's partly because I know uncertainty well. Many of my most important lessons didn't come from success, but from detours, wrong assumptions, and moments where I had to reorient myself."
                    )}</p>
                  <p>{t(
                      ...
                      "In over 15 years across academia, education, and business, I've seen how quickly people in high-performance environments start to function — instead of creating. And how much orientation suffers when no one helps hold the important questions: What matters to me? Who do I want to become? What's the next real step?"
                    )}</p>
                  <p>{t(
                      ...
                      "I'm building 2Morrow Lab because young people at transitions don't need more 'advice' — they need solid infrastructure, encouragement, and continuous, individual support: Life Design as practice, an AI as companion (not replacement), and real development partnerships with people who walk alongside them."
                    )}</p>
                </div>
