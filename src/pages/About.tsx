            ...
            <motion.div {...fadeUp} className="grid md:grid-cols-3 gap-8 items-start">
              ...
              <div className="md:col-span-2 space-y-5">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>{t(
                      'Mein name Sohrab, kurz "So", und für viele Menschen wirke oft klar und strukturiert. Aber das kommt auch daher, dass ich Unsicherheit gut kenne. Viele meiner wichtigsten Lernschritte kamen nicht aus Erfolgen, sondern aus Umwegen, Fehlannahmen und Momenten, in denen ich mich neu sortieren musste.',
                      'My name is Sohrab, "So" for short, and to many people I often seem clear and structured. But that also comes from knowing uncertainty well. Many of my most important learning steps came not from successes, but from detours, wrong assumptions, and moments where I had to reorient myself.'
                    )}</p>
                  <p>{t(
                      'In über 15 Jahren in Sport, Wissenschaft, Bildung und Wirtschaft habe ich gesehen, wie schnell Menschen in leistungsstarken Umfeldern anfangen zu funktionieren – statt zu gestalten. Und wie sehr Orientierung leidet, wenn niemand hilft, die wichtigen Fragen auszuhalten: Was ist mir wichtig? Wer will ich werden? Was ist der nächste echte Schritt?',
                      'In over 15 years in sports, science, education, and business, I have seen how quickly people in high-performance environments start to function — instead of creating. And how much orientation suffers when no one helps to sit with the important questions: What matters to me? Who do I want to become? What is the next real step?'
                    )}</p>
                  <p>{t(
                      'Als Basketball Spieler und Trainer habe ich früh gelernt: Die beste Version von sich selbst zu werden ist Teamsport. Deshalb baue ich 2Morrow Lab, weil junge Menschen an Übergängen nicht noch mehr „Ratgeber" brauchen, sondern eine tragfähige Infrastruktur, Ermutigung und kontinuierliche, individuelle Begleitung: Life Design als Praxis, eine KI als Begleiter (nicht als Ersatz), und echte Entwicklungspartnerschaften mit Menschen, die mitgehen.',
                      'As a basketball player and coach, I learned early on: becoming the best version of yourself is a team sport. That\'s why I\'m building 2Morrow Lab, because young people at transitions don\'t need more "advisors" — they need sustainable infrastructure, encouragement, and continuous, individual support: Life Design as practice, an AI as companion (not replacement), and real development partnerships with people who walk alongside them.'
                    )}</p>
                </div>
