  ...
  const cases: MiniCase[] = [
    {
      ...
      modules: [
        ...
        t('B1 Onboarding 30/60/90 mit Coaching & Companion App', 'B1 Onboarding 30/60/90 with Coaching & Companion App'),
    ...
    },
    {
      ...
      modules: [
        ...
        t('B1 Onboarding-Journeys individualisiert via Companion App (für Schlüsselbereiche)', 'B1 Onboarding journeys individualized via Companion App (for key areas)'),
        t('C1 Talent Development System (Lernpfade/Pathways)', 'C1 Talent Development System (learning paths/pathways)'),
    ...
    },
    {
      ...
      modules: [
        ...
        t('A4 Employer Branding als Entwicklungsversprechen', 'A4 Employer Branding as Development Promise'),
        t('B1 Onboarding 30/60/90 mit Coaching & Companion App + B2 Buddy-System', 'B1 Onboarding 30/60/90 with Coaching & Companion App + B2 Buddy System'),
